...
namespace Forc.WebApi.Migrations
{
    ...
    [Migration("20231005075323_AlterTable_User_AddColumnHasPhoto")]
    partial class AlterTable_User_AddColumnHasPhoto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.CompositionItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.DailyRate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.Dish", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.DishCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.Meal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.MealItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.PhysicalActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.ProductGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.ResourceSpecification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.SpecNutritionValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.UserDishCollection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.UserTarget", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.WeightCondition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DishDishCategory", b =>
                {
                    b.HasOne("Forc.Infrastructure.Models.DishCategory", null)
                        .WithMany()
                        .HasForeignKey("DishCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Forc.Infrastructure.Models.Dish", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DishUserDishCollection", b =>
                {
                    ...
                    b.HasOne("Forc.Infrastructure.Models.UserDishCollection", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.CompositionItem", b =>
                {
                    b.HasOne("Forc.Infrastructure.Models.Product", "Product")
                        .WithMany("CompositionItems")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Forc.Infrastructure.Models.ResourceSpecification", "ResourceSpecification")
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.Meal", b =>
                {
                    b.HasOne("Forc.Infrastructure.Models.User", "User")
                        .WithMany("Meals")
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.MealItem", b =>
                {
                    b.HasOne("Forc.Infrastructure.Models.Dish", "Dish")
                        .WithMany("MealItems")
                        .HasForeignKey("DishId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Forc.Infrastructure.Models.Meal", "Meal")
                        .WithMany("MealItems")
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.Product", b =>
                {
                    b.HasOne("Forc.Infrastructure.Models.ProductGroup", "ProductGroup")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.ResourceSpecification", b =>
                {
                    b.HasOne("Forc.Infrastructure.Models.Dish", "Dish")
                        ...
                        .HasForeignKey("Forc.Infrastructure.Models.ResourceSpecification", "DishId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.SpecNutritionValue", b =>
                {
                    b.HasOne("Forc.Infrastructure.Models.ResourceSpecification", "ResourceSpecification")
                        ...
                        .HasForeignKey("Forc.Infrastructure.Models.SpecNutritionValue", "ResourceSpecificationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.User", b =>
                {
                    b.HasOne("Forc.Infrastructure.Models.PhysicalActivity", "PhysicalActivity")
                        .WithMany("Users")
                        .HasForeignKey("PhysicalActivityId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Forc.Infrastructure.Models.UserDishCollection", "UserDishCollection")
                        .WithOne("User")
                        .HasForeignKey("Forc.Infrastructure.Models.User", "UserDishCollectionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Forc.Infrastructure.Models.UserTarget", b =>
                {
                    b.HasOne("Forc.Infrastructure.Models.DailyRate", "DailyRate")
                        .WithOne("UserTarget")
                        .HasForeignKey("Forc.Infrastructure.Models.UserTarget", "DailyRateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Forc.Infrastructure.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
